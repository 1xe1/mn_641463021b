...
class _UpdateProductState extends State<UpdateProduct> {
  ...
  void _initializeFields() {
    ...
    _selectedShopID = widget.product['ShopID'].toString();
    _unitController.text = widget.product['Unit'].toString();
  ...
  Future<void> submitForm(BuildContext context) async {
    ...
    try {
      ...
      final response = await http.put(
        Uri.parse(apiUrl),
        body: jsonEncode({
          'ProductID': widget.product['ProductID'], // Provide the ProductID to update
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text("Error"),
              content: Text(
                  "Failed to update product. Error ${response.statusCode}"),
              actions: <Widget>[
                TextButton(
                  child: Text("OK"),
                  onPressed: () {
